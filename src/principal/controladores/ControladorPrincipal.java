...
public class ControladorPrincipal {
    public static void main(String[] args) {
        ...
        ProductoDelPedido pdp1 = new ProductoDelPedido(gestorProductos.menu().get(0), 1);
        ProductoDelPedido pdp2 = new ProductoDelPedido(gestorProductos.menu().get(1), 2);        
        ...
        System.out.println("7."+gestorPedidos.crearPedido(LocalDate.now(), LocalTime.now(), productosDelPedido1, (Cliente)gestorUsuarios.verUsuarios().get(0)));
